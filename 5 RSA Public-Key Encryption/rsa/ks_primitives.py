...
class Byte(object):
    ...
    def __sub__(self, other):
        ...
        if not isinstance(other, Byte):
            # Bytes can only be subtracted from other Bytes.
    ...
    def __mul__(self, other):
        ...
        if not isinstance(other, Byte):
            # Bytes can only be multiplied to other Bytes.
            return NotImplemented
    ...
    def __init__(self, value):
        ...
        self._byte = value
        self._hex = Byte._hex_digits[value >> 4] + \
            Byte._hex_digits[value & 0xF]
...
class Word(object):
    ...
    def __sub__(self, other):
        ...
        if not isinstance(other, Word):
            # Words can only be subtracted from other Words.
            return NotImplemented
