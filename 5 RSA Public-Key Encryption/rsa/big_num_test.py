...
class BigNumTest(unittest.TestCase):
    ...
    def test_addition(self):
        ...
        self.assertEqual(BigNum.h('1234') +
                         BigNum.h('56789A'), BigNum.h('568ACE'))
        self.assertEqual(BigNum.one() + BigNum.h('FFFFFF'),
                         BigNum.h('1000000'))
    ...
    def test_subtraction(self):
        ...
        self.assertEqual(BigNum.h('56789A') -
                         BigNum.h('4321'), BigNum.h('563579'))
        self.assertEqual(BigNum.h('4321') -
                         BigNum.h('56789A'), BigNum.h('A9CA87'))
        ...
        self.assertEqual(BigNum.one() - BigNum.h('1000000'),
                         BigNum.h('FF000001'))
    ...
    def test_multiplication(self):
        ...
        self.assertEqual(BigNum.h('1234') * BigNum.h('5678'),
                         BigNum.h('06260060'))
    ...
    def test_division(self):
        self.assertEqual(BigNum.one() // BigNum.one(),
                         BigNum.one(), '1 // 1 == 1')
        ...
        self.assertEqual(BigNum.h('06260060') //
                         BigNum.h('1234'), BigNum.h('5678'))
        self.assertEqual(BigNum.h('06263F29') //
                         BigNum.h('5678'), BigNum.h('1234'))
    ...
    def test_modulo(self):
        self.assertEqual(BigNum.one() % BigNum.one(),
                         BigNum.zero(), '1 % 1 == 0')
        self.assertEqual(BigNum.zero() % BigNum.one(),
                         BigNum.zero(), '0 % 1 == 0')
        ...
        self.assertEqual(BigNum.h('06260060') %
                         BigNum.h('1234'), BigNum.zero())
        self.assertEqual(BigNum.h('06263F29') %
                         BigNum.h('5678'), BigNum.h('3EC9'))
        self.assertEqual(BigNum.h('06260FE3C9') % BigNum.h('56789A'),
                         BigNum.h('49081'))
        self.assertEqual(BigNum.h('FFFFFE000001') % BigNum.h('FFFFFF'),
                         BigNum.zero())
    ...
    def test_powmod(self):
        ...
        self.assertEqual(BigNum.h('42').powmod(
            BigNum.zero(), modulo), BigNum.one())
